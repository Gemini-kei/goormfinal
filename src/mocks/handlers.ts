...
export const handlers = [
  // 회원가입 API 요청 목킹
  rest.post('/api/proxy/members', async (req, res, ctx) => {
  ...
  rest.post('/api/proxy/check-email', async(req, res, ctx) => {
  ...
  // 로그인 API 모킹
  rest.post('/api/proxy/members/login', async (req, res, ctx) => {
  ...
  //로그아웃 API 모킹
  rest.post('/api/proxy/members/logout', (req, res, ctx) => {
  ...
  rest.get('/api/proxy/markers', (req, res, ctx) => {
